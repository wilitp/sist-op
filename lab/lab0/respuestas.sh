...
sort -k 3 --sort=g atpplayers.in # --sort=g <- ordenar interpretando como números
...
#### 7)
ip l |grep 'link/ether ..:..:..:..:..:..' |grep  '..:..:..:..:..:..' -o # imprime las macs de todas las interfaces de ethernet 
